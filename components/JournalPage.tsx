  ...
  return (
    <div className="space-y-6 p-4">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Your Journal</h2>
      ...
      <Card>
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-800">New Entry</h3>
        </div>

        <textarea
          value={currentEntry}
          onChange={(e) => setCurrentEntry(e.target.value)}
          placeholder="What's on your mind today? Share your thoughts, feelings, ideas, or anything you'd like to remember..."
        ...
        <button
          ...
          className="mt-4 bg-gradient-to-r from-[#A8D5BA] to-[#C5CAE9] text-gray-800 py-2 px-6 rounded-lg font-semibold hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
        >
          {isSaving ? (
            <>
